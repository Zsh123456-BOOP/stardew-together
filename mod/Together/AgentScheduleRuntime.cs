...
public sealed partial class ModEntry {
    ...
    private object QueueLegacyAction(AgentCall call) {
        ...
        var task=new AgentTaskSpec{id="step-"+Guid.NewGuid().ToString("N"),actor=actor,tool=call.tool,args=call.args.Clone(),location=call.tool is "player.read_mail" or "player.watch_tv" or "player.transport" or "player.repair_boat" or "player.read_book" or "player.mastery" or "player.orchard" or "player.joja" or "player.place_facility" or "player.ship_items" or "player.order_donate" or "player.animal" or "player.upgrade_house" or "player.mine_access" or "player.bundle" or "player.travel" or "player.sleep" or "player.service" or "player.social" or "player.care" or "player.machine" or "player.cook" or "work.run"?"":location,day=Game1.Date.TotalDays,purpose=Data.Autoplay.Plan[..Math.Min(160,Data.Autoplay.Plan.Length)]};
