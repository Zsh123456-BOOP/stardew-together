...
public sealed class AgentToolRegistry {
    ...
    public static readonly Dictionary<string,string> Catalog=new(){
        ...
        ["player.combat"]="{quest_id?:已观察讨伐任务ID,count?:0..50,min_health?:20..200}: 指定quest_id时优先真实目标敌人且按该任务计数；选择背包近战武器，当前地图持续接近/原生挥击/换目标；0清理当前已出现怪物，原生击杀归属核验，低生命或无伤害停止请求撤退/换策略；不宣称已有全部敌种战术",
