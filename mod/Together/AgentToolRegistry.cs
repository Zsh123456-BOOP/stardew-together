...
public sealed class AgentToolRegistry {
    ...
    public static readonly Dictionary<string,string> Catalog=new(){
        ...
        ["goal.create"]="{request_id:string,entity:物品ID或craft:配方名,count?:int,completion?:owned|crafted}: 幂等创建持久共同目标，原生配方自动展开依赖并预留材料，不打开UI",
