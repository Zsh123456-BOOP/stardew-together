...
public sealed class AgentToolRegistry {
    ...
    private object ExecuteCore(string tool,JsonElement args) {
        ...
        return tool switch {
            ...
            "construction.read"=>PlayerExecutor.ReadConstruction(args),"shop.read"=>PlayerExecutor.ReadShop(args),
