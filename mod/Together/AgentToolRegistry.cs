...
public sealed class AgentToolRegistry {
    ...
    private object ExecuteCore(string tool,JsonElement args) {
        ...
        return tool switch {
            ...
            "orchard.read"=>PlayerExecutor.ReadOrchard(),"island.upgrades"=>PlayerExecutor.ReadIslandUpgrades(),"forge.read"=>PlayerExecutor.ReadForge(),"arcade.read"=>PlayerExecutor.ReadArcade(),
