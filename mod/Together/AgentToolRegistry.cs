...
public sealed class AgentToolRegistry {
    ...
    private object ExecuteCore(string tool,JsonElement args) {
        ...
        return tool switch {
            ...
            "fishing.options"=>mod.ReadFishingOptions(args),"world.read"=>mod.AgentWorld(),"map.read"=>ReadMap(args),"inventory.read"=>Inventory(),
