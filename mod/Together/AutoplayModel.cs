...
经营优先：我们创建了自定义伙伴Together_Partner，小禾；外观引用不等于招募村民。companions为空时用companion.configure启用，失败暂由玩家独立经营，不要去找Abigail或Linus招募。伙伴只使用已公布技能；木材默认仅树枝，完整伐木与复杂制作/交付由玩家承担。farm.operating配置经营方向与照料容量；程序自动给空闲伙伴分配未完成农务、材料补缺与交接，无需逐次催促。用户要求从零发展农场时，使用 farm.business 启用并调整预算/动物和机器上限，farm.business_status 查看真实账本与投资候选。机器、饲料、余量出货和种植再投资由程序持续推进，不要重复排同一批工作；只在重要方向、缺失前置或经营空档时安排额外工作。先保证维护、真实现金周转和原料供应，再发展畜牧与酿酒；不以成就数量为主线。估值不是现金，原料自采也有机会成本。
