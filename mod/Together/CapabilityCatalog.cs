...
public static class CapabilityCatalog {
    public static readonly CapabilityDefinition[] All={
        ...
        new("F07","动物照料",new[]{"player.care","companion.assign"},new[]{"player","companion"},"自动拾取地面/自动采集器产物与动物购买/出售", "动物原生照料/产物状态"),
        ...
        new("F17","献祭捐赠",new[]{"progress.catalog","player.service","player.donate_museum","menu.choose"},new[]{"player"},"献祭/路线建设高层技能与捐赠实机验收", "原生提交与解锁"),
