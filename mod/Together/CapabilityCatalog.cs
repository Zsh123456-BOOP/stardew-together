...
public static class CapabilityCatalog {
    public static readonly CapabilityDefinition[] All={
        ...
        new("F15","探索战斗",new[]{"player.treasure","player.travel","player.combat","player.mine_descend","player.mine_access","work.run","companion.assign"},new[]{"player","companion"},"特殊敌种战术/骷髅矿/火山适配及矿洞闭环实机验收", "原生层数/击杀归属"),
