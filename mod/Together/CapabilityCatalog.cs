...
public static class CapabilityCatalog {
    public static readonly CapabilityDefinition[] All={
        ...
        new("F19","特殊剧情区域",new[]{"island.upgrades","player.island_upgrade","forge.read","player.forge","player.mastery","mastery.read","player.read_book","menu.read","menu.choose"},new[]{"player"},"节日/姜岛核桃谜题/首次火山探索专属适配及后期实机验收", "逐事件原生证据"),
