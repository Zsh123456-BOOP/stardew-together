...
public static class ContextBudget {
    ...
    private static readonly HashSet<string> Protected=new(new[]{"pending_queries","task_card","recent","goal","now","inventory","ui","night","commitments","protection_reasons","planting_execution","prerequisites","active_actors","decision_reasons","schedule","operating_candidates","decision_review","purchase_status","deliberation","farm_work","assets","labor_budget","day","service_hours","goals"},StringComparer.Ordinal);
