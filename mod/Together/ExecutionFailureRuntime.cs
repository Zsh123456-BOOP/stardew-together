...
public sealed partial class ModEntry {
    private static bool RecoverableExecutionFailure(string reason)=>FailureKnowledge.Family(reason) is "capacity" or "access" or "targets" or "material_policy"||reason.StartsWith("known_failure_conditions_unchanged:")||reason.StartsWith("plan_on_farm_or_greenhouse_first_travel_to_")||reason is "path_stalled" or "no_path" or "action_timeout" or "remaining_targets_unreachable";
