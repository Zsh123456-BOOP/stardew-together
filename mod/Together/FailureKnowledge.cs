...
public sealed class FailureKnowledge {
    ...
    public FailureExperience? Block(string key,string conditions,int day,int minute)=>Entries.LastOrDefault(e=>e.Key==key&&e.Conditions==conditions&&e.Day==day&&(e.UntilChanged||minute<e.RetryAfterMinute));
