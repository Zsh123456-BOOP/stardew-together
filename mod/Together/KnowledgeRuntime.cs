...
public sealed partial class ModEntry {
    ...
    private void StartKnowledgeCall(bool plan) {
        ...
        // Recollections already appear as attributed facts in the packet. A second ID namespace confuses citation validation.
        pending=ModelClient.AskKnowledge(file,Settings.Model,new{question=knowledgeQuestion,profile=Current.Profile,evidence,memory_owner=Selected},plan);
