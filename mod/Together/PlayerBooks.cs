...
public sealed partial class PlayerExecutor {
    ...
    private uint bookPower,bookMasteryExperience;
    ...
    private void StartReadBook(JsonElement args) {
        ...
        bookExperience=Game1.player.experiencePoints.ToArray();bookRecipes=KnownRecipeKeys();bookMasteryExperience=Game1.stats.Get("MasteryExp");
    ...
    private void TickReadBook() {
        ...
        bool changed=power>bookPower||experience.Where((value,index)=>value>bookExperience[index]).Any()||learned.Length>0||mastery>bookMasteryExperience;
        Current!.effects.Add(new{kind="native_book_read",book=bookItem,consumed=1,power_before=bookPower,power_after=power,experience_before=bookExperience,experience_after=experience,mastery_before=bookMasteryExperience,mastery_after=mastery,recipes_learned=learned});
