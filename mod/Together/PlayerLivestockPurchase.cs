...
public sealed partial class PlayerExecutor {
    ...
    private void StartLivestockPurchase(JsonElement args) {
        ...
        if(livestockName.Length is <1 or >24||livestockName.Any(char.IsControl)||Utility.areThereAnyOtherAnimalsWithThisName(livestockName))throw new InvalidOperationException("unique_animal_name_required_max24");
