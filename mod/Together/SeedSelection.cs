...
public sealed partial class ModEntry {
    ...
    private string seedSelectionIntent="";
    private int SeedAllowance()=>AutonomyPolicy.Cash(Game1.player.Money,Data.FarmInvestment.KeepGold,Data.FarmInvestment.BudgetPerDay,NativePurchaseSpent(),PendingPurchaseCash(),Data.Operating.DevelopmentCashHeld);
    ...
    internal object SelectSeeds(JsonElement args) {
        ...
        selectedSeeds=chosen;selectionApproved=true;seedSelectionIntent=decisionIntent;Data.FarmInvestment.Enabled=true;
