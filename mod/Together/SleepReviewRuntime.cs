...
public sealed partial class ModEntry {
    ...
    private bool ReviewQueuedSleep(ScheduledAgentTask task) {
        ...
        bool changed=task.spec.sleep_review_day!=Game1.Date.TotalDays||task.spec.sleep_review_progress!=Data.Autoplay.VerifiedActions||task.spec.sleep_review_time!=Game1.timeOfDay;
