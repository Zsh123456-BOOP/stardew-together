...
a=action('player.work',skill='clear',slot=0,tiles=[{'x':61,'y':18},{'x':62,'y':18}])
check(a['completed']==2 and count(a['after'],'(O)388')-count(a['before'],'(O)388')==2,'both twigs yield native wood, including final pickup')
