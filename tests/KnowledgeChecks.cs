...
public static class KnowledgeChecks {
    public static void Run(Action<bool,string> check) {
        ...
        check(saved.Knowledge.Recent.SequenceEqual(book.Recent) && saved.Knowledge.DiscoveredOnly && saved.SchemaVersion==6,"knowledge save persistence, downgrade protection and spoiler-safe default");
