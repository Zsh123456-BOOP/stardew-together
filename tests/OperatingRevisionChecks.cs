...
static class OperatingRevisionChecks {
    public static void Run(Action<bool,string> check) {
        ...
        check(conditionMemory.Block(semantic,"policy-A",3,1400)!=null&&conditionMemory.Block(semantic,"policy-B",3,601)==null,"persistent failure waits for relevant state change, not elapsed time");
        conditionMemory.Success(semantic);check(conditionMemory.Block(semantic,"policy-A",3,601)==null,"verified success clears the semantic failure memory");
