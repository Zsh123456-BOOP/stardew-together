...
public static class SurvivalChecks {
    public static void Run(Action<bool,string> check) {
        ...
        check(!SurvivalState.NightGuard(2200,false)&&!SurvivalState.NightGuard(2450,false)&&SurvivalState.NightGuard(2500,false)&&!SurvivalState.NightGuard(2500,true),"night warning precedes late no-plan guard; effective plans remain owned");
        check(!SurvivalState.NightGuard(2420,false,90)&&SurvivalState.NightGuard(2430,false,90),"remote return reserve moves no-plan safeguard before native passout");
